package otaibe.quarkus.amazon.lambda.runtime;
...
public class LambdaClientProducer {
  ...
  LambdaClientProducer(
    ...
    syncClient =
        syncClientBuilderInstance.isResolvable() ? syncClientBuilderInstance.get().build() : null;
    asyncClient =
        asyncClientBuilderInstance.isResolvable() ? asyncClientBuilderInstance.get().build() : null;
  }
