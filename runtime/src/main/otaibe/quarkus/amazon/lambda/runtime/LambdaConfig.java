...
public interface LambdaConfig {
   ...
   *
   * <p>Accelerate endpoints allow faster transfer of objects by using Amazon CloudFront's globally
   ...
   * 'true'.
   *
   * <p>If not specified, the value in `AWS_PROFILE` environment variable or `aws.profile` system
